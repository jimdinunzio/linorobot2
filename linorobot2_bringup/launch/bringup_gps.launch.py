...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            name='odom_global_topic',
            default_value='/odom/global',
            description='EKF out global odometry topic'
        ),
        ...
        Node(
            ...
            remappings=[("odometry/filtered", LaunchConfiguration("odom_global_topic"))]
        ),

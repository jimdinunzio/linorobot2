...
def generate_launch_description():
    ...
    # add code to conditionally return a launch description with an includelaunchdescription of a python launch description source 
    # of package slamware_ros_sdk and launch file slamware_ros_sdk_server_node.launch.py if the launchconfiguration variable 'sensor' is 'm1m1'
    if LaunchConfigurationEquals('sensor', 'm1m1'):
        return LaunchDescription([
            IncludeLaunchDescription(
                PythonLaunchDescriptionSource(
                    PathJoinSubstitution(
                        [FindPackageShare('slamware_ros_sdk'), 'launch', 'slamware_ros_sdk_server_node.launch.py']
                    )
                )
            )
        ])
